    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">Guia Olinda</a>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <h2 class="section-heading">Tudo o que você precisa!</h2>
                    <hr class="light">
                    <p class="text-faded">Descubra Olinda da maneira mais divertida! Conheça os locais mais badalados e interessantes de uma das cidades mais culturais do estado. Encontre exatamente o que procura dentre os muitos destinos.</p>
                    <a href="#services" class="page-scroll btn btn-default btn-xl sr-button"><i class="fa fa-chevron-down"></i></a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="service-box">
                        ...
                        <h3>Base sólida</h3>
                        <p class="text-muted">Montada sobre o guia turístico oferecido pela Prefeitura de Olinda</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="service-box">
                        ...
                        <h3>Atualizado</h3>
                        <p class="text-muted">Adicionando novos destinos sempre que surgem.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="service-box">
                        ...
                        <h3>UFRPE</h3>
                        <p class="text-muted">Desenvolvido por estudantes de Sistemas de Informação</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    ...
                    <hr class="primary">
                    <p>Preparado para aproveitar tudo o que Olinda tem a oferecer? Ótimo! Entre em contato conosco!</p>
                </div>
                <div class="col-lg-12 text-center">
                    <i class="fa fa-envelope-o fa-3x sr-contact"></i>
                    <p><a href="mailto:your-email@your-domain.com">contatoguiaolinda@gmail.com</a></p>
                </div>
            </div>
        </div>
    </section>
